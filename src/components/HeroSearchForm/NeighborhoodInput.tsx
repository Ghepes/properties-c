...
const NeighborhoodInput: FC<LocationInputProps> = ({
  ...
  return (
    <div className={`relative flex ${className}`} ref={containerRef}>
      ...
      {showPopover && (
        <div className="absolute left-0 z-40 w-full min-w-[300px] sm:min-w-[600px] bg-white dark:bg-neutral-800 top-full mt-3 py-3 sm:py-6 rounded-3xl shadow-xl max-h-96 overflow-y-auto">
